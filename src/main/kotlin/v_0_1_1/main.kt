...
fun main() {
    ...
    val plot = plot {
        ...
        val name = DataSource<String>("name")
        val iq = DataSource<Int>("iq")
        val year = DataSource<Int>("year") // datetime
        ...
        // bars lines
        points {
            y mapTo iq scaleContinuous {
                limits = 0 to 100
            }
            color mapTo year scaleCategorical {
                categories = listOf(1220, 1233)
        ...
        points {
            ...
            size setTo 3.4
            color setTo "#ff00ff" // TODO wrapper?
        }
    }
/*
 val json = Json {
